...
class LoginViewController: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        emailField.frame = CGRect(x: 25, y: headerView.bottom + 40, width: view.width - 50, height: 52.0)
    ...
    @objc private func didTapLoginButton () {
        ...
        guard let email = emailField.text, !email.isEmpty, let password = passwordField.text, !password.isEmpty, password.count >= 8 else {
                return
        }
    ...
    @objc private func didTapTermsButton () {
        guard let url = URL(string: "https://www.berwickacademy.org/") else {
            return
        }
    ...
    @objc private func didTapPrivacyButton () {
        guard let url = URL(string: "https://www.berwickacademy.org/about-us") else {
            return
        }
        let vc = SFSafariViewController(url: url)
        present(vc, animated: true)
